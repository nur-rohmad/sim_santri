        ...
        <div class="card-body">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="name">ID Mapel*</label>
              <input class="form-control <?php echo form_error('id_mapel') ? 'is-invalid' : '' ?>" type="text" name="id_mapel" min="0" placeholder="ID Mapel.." />
            ...
            <div class="form-group">
              ...
              <input class="form-control <?php echo form_error('nama_mapel') ? 'is-invalid' : '' ?>" type="text" name="nama_mapel" min="0" placeholder="Nama Mapel.." />
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input class="form-control <?php echo form_error('ustad_pengajar') ? 'is-invalid' : '' ?>" type="text" name="ustad_pengajar" min="0" placeholder="Usatd Pengajar.." />
              <div class="invalid-feedback">
